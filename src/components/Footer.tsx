    ...
    <footer className="bg-slate-900 text-white py-12 px-4 md:px-16">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center mb-8">
          <div className="font-extrabold text-2xl mb-6 md:mb-0 text-pink-400">HOPELY.org</div>
          
          <div className="flex flex-wrap justify-center md:justify-end gap-6 text-sm mb-6 md:mb-0">
            <a href="#" className="hover:text-pink-400 transition-colors">What We Do</a>
            <a href="#" className="hover:text-pink-400 transition-colors">Get Involved</a>
            <a href="#" className="hover:text-pink-400 transition-colors">Projects</a>
            <a href="#" className="hover:text-pink-400 transition-colors">Donate</a>
          </div>
          ...
          <div className="flex space-x-4">
            <a 
              ...
              className="hover:text-pink-400 transition-colors hover:scale-110 transform duration-200"
            >
